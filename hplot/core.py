...
class HPlot:
    ...
    def plot(self, ci_show=True, ax=None, display_base_type="tumor", display_target_type="immune cells"):
        ...
        return plot_hplot(self.target_grouped_stats_, base_grouped_stats=self.base_grouped_stats_ or None, distance_unit=self.distance_unit, ci_show=ci_show, ax=ax, display_base_type=display_base_type, display_target_type=display_target_type, color_map=self.color_map, palette=self.palette, legend_order=self.legend_order, legend_title=self.legend_title, legend_kwargs=self.legend_kwargs)
